        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    ...
                    <p class="mb-4">The best part about Subease? <strong>It's totally FREE</strong>. It isn't about making money it's about making connections, helping you find work and get paid.</p>

                    <p class="mb-4">For me, Subease is a passion project. I'm building something that I think the Construction Industry needs, but I'm also building something that I want myself!</p>
                        ...
                        <div class="mb-3">
                            <form method="post" name="user_handle_reservation">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="user_handle_reservation_email" name="user_handle_reservation[email]" required="required" placeholder="richard@piedpiper.com" title="Your Email Address" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="user_handle_reservation_handle" name="user_handle_reservation[handle]" required="required" placeholder="PP_Plumbers" title="Your handle" class="form-control">
